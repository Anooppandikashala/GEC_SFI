...
public class ThirdFloorPartTwoDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_floor_part_two_desc);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ThirdFloorPartTwoDesc.super.onBackPressed();
            }
        });
