...
public class GroundFloorPartOneDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ground_floor_part_one_desc);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GroundFloorPartOneDesc.super.onBackPressed();
            }
        });
