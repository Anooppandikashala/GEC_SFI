...
public class SecondFloorPartOneDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_floor_part_one_desc);

        listDataHeader = new ArrayList<>();

        listDataHeader.add("IT Department Library");
        listDataHeader.add("KTU Exam Office");
        listDataHeader.add("Cse seminar hall");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SecondFloorPartOneDesc.super.onBackPressed();
            }
        });
