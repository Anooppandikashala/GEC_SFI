...
public class FirstFloorPartOneDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_floor_part_one_desc);

        listDataHeader = new ArrayList<>();

        listDataHeader.add("Cse Department Library");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FirstFloorPartOneDesc.super.onBackPressed();
            }
        });
