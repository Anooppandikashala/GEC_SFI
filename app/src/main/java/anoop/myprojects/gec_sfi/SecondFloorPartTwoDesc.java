...
public class SecondFloorPartTwoDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_floor_part_two_desc);

        listDataHeader = new ArrayList<>();

        listDataHeader.add("Mech Department Library");
        listDataHeader.add("NSS Room");
        listDataHeader.add("Conference Hall");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SecondFloorPartTwoDesc.super.onBackPressed();
            }
        });
        ...
        network.add("Department library of Mechanical Engineering");

        List<String> project = new ArrayList<>();
        project.add("Room provided for National Service Scheme ");
