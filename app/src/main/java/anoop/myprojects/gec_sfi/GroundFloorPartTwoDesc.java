...
public class GroundFloorPartTwoDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ground_floor_part_two_desc);

        listDataHeader = new ArrayList<>();

        listDataHeader.add("PTA Office");
        listDataHeader.add("Sports Room");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GroundFloorPartTwoDesc.super.onBackPressed();
            }
        });
